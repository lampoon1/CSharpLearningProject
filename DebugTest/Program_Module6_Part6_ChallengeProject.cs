...
//
//download get zip files:
//Cash Register project continues. There is some logic issues and need to debug and fix
//
//expected output: (when the amount on hand and till balanced and equal)
//The till has 1184 dollars
//Expected till value: 1184
//
//////////////////////////////////////////////
//Unit 3, 4,
//Unit 3 - Exercise - Use the test data to expose logic issues in a C# console application
/// Starter Project Code:
/*
This application manages transactions at a store check-out line. 
The check-out line has a cash register, and the register has a cash till
that is prepared with a number of bills each morning. 
...
The customer offers payment based on an algorithm that determines 
a number of bills in each denomination. 

Each day, the cash till is loaded at the start of the day. 
As transactions occur, the cash till is managed in a method named 
MakeChange (customer payments go in and the change 
returned to the customer comes out). 
A separate "safety check" calculation that's used to verify 
the amount of money in the till is performed in the "main program". 
This safety check is used to ensure that logic in the 
MakeChange method is working as expected.
*/
//expected OUTPUT:
...
Customer is making a $11 purchase
...
Cashier prepares the following change:
         A ten
The till has 361 dollars
Expected till value: 361
...
Expected till value: 379

Customer is making a $46 purchase
...
//
//By configuring the debug environment and successfully debugging 
//the cash register application, you demonstrated your ability to use 
//the Visual Studio Code debugger tools for C#. 
//You began by ensuring that the launch.json file was configured correctly to support your application. 
//Then you ran the application, 
//reviewed the generated output, 
//and identified the logic issue. 
//After that you used the Visual Studio Code debugger tools to isolate and fix the logic issues. 
//When you were finished, you saved your updated application and ran the application 
//to demonstrate that the application performed as intended.

//Your ability to debug the cash register application demonstrates 
//your ability to implement the Visual Studio Code debugger tools for C#.
/// 
///
/// /////////////////////END OF Challenge Project ////////////////////////
/// ////////////////////////////////////////////////////////////////////////